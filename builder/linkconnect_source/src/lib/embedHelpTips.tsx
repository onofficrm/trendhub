...
export const EMBED_HELP: Record<string, { title: string; body: ReactNode }> = {
  ...
  design: {
    title: '디자인 · 폼 필드 · 완료 후 이동',
    body: (
      <TipBody
        why="강조색·제목·버튼 문구, 지역/문의 필드 표시 여부, 접수 후 안내 문구와 이동 URL을 정합니다."
        ifSkip="완료 후 이동 URL을 쓰면 접수 직후 고객을 감사 페이지 등으로 보냅니다. 허용 도메인을 등록했다면 같은 도메인 URL만 가능합니다."
        tip="문구는 짧게, 개인정보 동의 문장은 사이트 정책에 맞게 수정하세요."
      />
    ),
  },
  wordpress: {
